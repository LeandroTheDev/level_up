        ...
        foreach (ItemSlot armorSlot in items)
        {
            ...
            if (armor.StatModifers != null)
            {
                if (armorSlot.Itemstack.Attributes.TryGetFloat("BaseHealingEffectivness") != null)
                {
                    ...
                    Debug.LogDebug($"[ChainArmor] Stats updated healingeffectivness: {baseValue}/{armor.StatModifers.healingeffectivness}");
                }
                if (armorSlot.Itemstack.Attributes.TryGetFloat("BaseHungerRate") != null)
                {
                    ...
                    Debug.LogDebug($"[ChainArmor] Stats updated hungerrate: {baseValue}/{armor.StatModifers.hungerrate}");
                }
                if (armorSlot.Itemstack.Attributes.TryGetFloat("BaseRangedWeaponsAccuracy") != null)
                {
                    ...
                    Debug.LogDebug($"[ChainArmor] Stats updated rangedWeaponsAcc: {baseValue}/{armor.StatModifers.rangedWeaponsAcc}");
                }
                if (armorSlot.Itemstack.Attributes.TryGetFloat("BaseRangedWeaponsSpeed") != null)
                {
                    ...
                    Debug.LogDebug($"[ChainArmor] Stats updated rangedWeaponsSpeed: {baseValue}/{armor.StatModifers.rangedWeaponsSpeed}");
                }
                if (armorSlot.Itemstack.Attributes.TryGetFloat("BaseWalkSpeed") != null)
                {
                    ...
                    Debug.LogDebug($"[ChainArmor] Stats updated walkSpeed: {baseValue}/{armor.StatModifers.walkSpeed}");
                }
            }
            ...
            if (world.Api is ICoreClientAPI api)
            {
                ...
                if (__instance.ProtectionModifiers != null)
                {
                    if (inSlot.Itemstack.Attributes.TryGetFloat("BaseFlatDamageReduction") != null)
                    {
                        ...
                        Debug.LogDebug($"[ChainArmor] Info updated FlatDamageReduction: {inSlot.Itemstack.Attributes.GetFloat("BaseFlatDamageReduction") + difference}/{__instance.ProtectionModifiers.FlatDamageReduction}");
                    }
                    if (inSlot.Itemstack.Attributes.TryGetFloat("BaseRelativeProtection") != null)
                    {
                        ...
                        Debug.LogDebug($"[ChainArmor] Info updated RelativeProtection: {inSlot.Itemstack.Attributes.GetFloat("BaseRelativeProtection") + difference}/{__instance.ProtectionModifiers.RelativeProtection}");
                    }
                }
                ...
                if (__instance.StatModifers != null)
                {
                    if (inSlot.Itemstack.Attributes.TryGetFloat("BaseHealingEffectivness") != null)
                    {
                        ...
                        Debug.LogDebug($"[ChainArmor] Info updated healingeffectivness: {baseValue}/{__instance.StatModifers.healingeffectivness}");
                    }
                    if (inSlot.Itemstack.Attributes.TryGetFloat("BaseHungerRate") != null)
                    {
                        ...
                        Debug.LogDebug($"[ChainArmor] Info updated hungerrate: {baseValue}/{__instance.StatModifers.hungerrate}");
                    }
                    if (inSlot.Itemstack.Attributes.TryGetFloat("BaseRangedWeaponsAccuracy") != null)
                    {
                        ...
                        Debug.LogDebug($"[ChainArmor] Info updated rangedWeaponsAcc: {baseValue}/{__instance.StatModifers.rangedWeaponsAcc}");
                    }
                    if (inSlot.Itemstack.Attributes.TryGetFloat("BaseRangedWeaponsSpeed") != null)
                    {
                        ...
                        Debug.LogDebug($"[ChainArmor] Info updated rangedWeaponsSpeed: {baseValue}/{__instance.StatModifers.rangedWeaponsSpeed}");
                    }
                    if (inSlot.Itemstack.Attributes.TryGetFloat("BaseWalkSpeed") != null)
                    {
                        ...
                        Debug.LogDebug($"[ChainArmor] Info updated walkSpeed: {baseValue}/{__instance.StatModifers.walkSpeed}");
                    }
                }
