        ...
        foreach (ItemSlot armorSlot in items)
        {
            ...
            if (armor.StatModifers != null)
            {
                if (armorSlot.Itemstack.Attributes.TryGetFloat("BaseHealingEffectivness") != null)
                {
                    ...
                    Debug.LogDebug($"[BrigandineArmor] Stats updated healingeffectivness: {baseValue}/{armor.StatModifers.healingeffectivness}");
                }
                if (armorSlot.Itemstack.Attributes.TryGetFloat("BaseHungerRate") != null)
                {
                    ...
                    Debug.LogDebug($"[BrigandineArmor] Stats updated hungerrate: {baseValue}/{armor.StatModifers.hungerrate}");
                }
                if (armorSlot.Itemstack.Attributes.TryGetFloat("BaseRangedWeaponsAccuracy") != null)
                {
                    ...
                    Debug.LogDebug($"[BrigandineArmor] Stats updated rangedWeaponsAcc: {baseValue}/{armor.StatModifers.rangedWeaponsAcc}");
                }
                if (armorSlot.Itemstack.Attributes.TryGetFloat("BaseRangedWeaponsSpeed") != null)
                {
                    ...
                    Debug.LogDebug($"[BrigandineArmor] Stats updated rangedWeaponsSpeed: {baseValue}/{armor.StatModifers.rangedWeaponsSpeed}");
                }
                if (armorSlot.Itemstack.Attributes.TryGetFloat("BaseWalkSpeed") != null)
                {
                    ...
                    Debug.LogDebug($"[BrigandineArmor] Stats updated walkSpeed: {baseValue}/{armor.StatModifers.walkSpeed}");
                }
            }
            ...
            if (world.Api is ICoreClientAPI api)
            {
                ...
                if (__instance.ProtectionModifiers != null)
                {
                    if (inSlot.Itemstack.Attributes.TryGetFloat("BaseFlatDamageReduction") != null)
                    {
                        ...
                        Debug.LogDebug($"[BrigandineArmor] Info updated FlatDamageReduction: {inSlot.Itemstack.Attributes.GetFloat("BaseFlatDamageReduction") + difference}/{__instance.ProtectionModifiers.FlatDamageReduction}");
                    }
                    if (inSlot.Itemstack.Attributes.TryGetFloat("BaseRelativeProtection") != null)
                    {
                        ...
                        Debug.LogDebug($"[BrigandineArmor] Info updated RelativeProtection: {inSlot.Itemstack.Attributes.GetFloat("BaseRelativeProtection") + difference}/{__instance.ProtectionModifiers.RelativeProtection}");
                    }
                }
                ...
                if (__instance.StatModifers != null)
                {
                    if (inSlot.Itemstack.Attributes.TryGetFloat("BaseHealingEffectivness") != null)
                    {
                        ...
                        Debug.LogDebug($"[BrigandineArmor] Info updated healingeffectivness: {baseValue}/{__instance.StatModifers.healingeffectivness}");
                    }
                    if (inSlot.Itemstack.Attributes.TryGetFloat("BaseHungerRate") != null)
                    {
                        ...
                        Debug.LogDebug($"[BrigandineArmor] Info updated hungerrate: {baseValue}/{__instance.StatModifers.hungerrate}");
                    }
                    if (inSlot.Itemstack.Attributes.TryGetFloat("BaseRangedWeaponsAccuracy") != null)
                    {
                        ...
                        Debug.LogDebug($"[BrigandineArmor] Info updated rangedWeaponsAcc: {baseValue}/{__instance.StatModifers.rangedWeaponsAcc}");
                    }
                    if (inSlot.Itemstack.Attributes.TryGetFloat("BaseRangedWeaponsSpeed") != null)
                    {
                        ...
                        Debug.LogDebug($"[BrigandineArmor] Info updated rangedWeaponsSpeed: {baseValue}/{__instance.StatModifers.rangedWeaponsSpeed}");
                    }
                    if (inSlot.Itemstack.Attributes.TryGetFloat("BaseWalkSpeed") != null)
                    {
                        ...
                        Debug.LogDebug($"[BrigandineArmor] Info updated walkSpeed: {baseValue}/{__instance.StatModifers.walkSpeed}");
                    }
                }
